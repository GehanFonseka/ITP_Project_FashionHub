...
const C_AdminDBUpdateTMMensBlazer = ({ blazer, onClose, onUpdate }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`/api/tm-mensblazers/${blazer._id}`, formData);
  ...
  return (
    <div style={styles.modal}>
      <div style={styles.modalContent}>
        ...
        <h2>Update Tailor Made Mens Blazer</h2>
...
export default C_AdminDBUpdateTMMensBlazer;
