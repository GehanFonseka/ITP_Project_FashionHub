...
const A_AdminDBCandB = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        const response = await axios.post('/api/chainsandbracelets', formData, {
          headers: {
            'Content-Type': 'multipart/form-data',
          },
        });
        console.log("Response:", response); 
        alert("bracelet item has been added successfully.");
        setFormData({
          sellerNo: "",
          itemNo: "",
          name: "",
        ...
        setImageFile(null);
        setErrors({});
        navigate('/A_AdminSBMenCandB'); // Redirect to a success page or list page
      } catch (error) {
  ...
  return (
    <div style={styles.formBackground}>
      <div style={styles.container}>
        <h2 style={styles.heading}>Add New Chains & Bracelets Item</h2>
