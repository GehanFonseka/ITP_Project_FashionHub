...
const handleContactChange = (e) => {
  ...
  const handlecvcChange = (e) => {
    ...
    if (cvc === "") {
      setcvc(null);
    } else if (!quantityPattern.test(cvc)) {
        if (isNaN(cvc)) {
  ...
  return (
    ...
    <div className="min-h-screen">
      <div className="flex justify-center mt-28  items-center gap-4">
        <div>
          <div className="mb-10 text-3xl font-mono ml-[300px]">
            <h1>Fashion Hub</h1>
          </div>
          ...
          <form className="" onSubmit={handleSubmit}>
            <div className="max-h-[550px] mt-2 overflow-y-auto scrollbar-none">
              <div>
                <h3 className="font-semibold text-gray-700 ml-1">Email</h3>
                <input
              ...
              <div className="mt-4">
                <h3 className="font-semibold text-gray-700 ml-2">Delivery address</h3>
                <input
                  className=" bg-gray-100  border-white border-opacity-50  p-3 rounded-lg w-[750px] h-11"
                  type="text"
                  placeholder=""
    ...
    >
      ...
      <option value="Vavuniya">Vavuniya</option>
              ...
              <div className="h-20 w-[750px] mt-6 rounded-3xl bg-gray-200  bg-opacity-40">
                <div className="">
                  <button className=" ml-6 mt-6 text-xl font-mono opacity-50 ">
              ...
              <div className="ml-80">
                <div className="font-serif text-gray-600 text-xl mt-4">
                  Payment
                </div>
              </div>
              ...
              <div className="mt-4">
                <h3 className="font-semibold text-gray-700 ml-2">
                  Card Number
                </h3>
                <input
                  className=" bg-gray-100  border-white border-opacity-50  p-3 rounded-lg w-[750px] h-11"
              ...
              <div className="flex gap-12 mt-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-700 ml-2">CVC</h3>
                  <input
                    className="bg-gray-100  border-white border-opacity-50  p-3 rounded-lg w-[350px] h-11"
                    type="text"
                    placeholder="CVC"
            ...
            <button
              className=" bg-black  mt-6 mb-8  ml-[540px] border-white border border-opacity-50 text-white font-serif p-2 hover:text-red-300 rounded-lg w-[200px] h-[45px] hover:opacity-90"
              type="submit"
            >
        ...
        <div className="">
          <div className="w-[400px] h-screen mt-6 ml-36 shadow-sm scrollbar-none bg-gray-100 overflow-auto">
            <div className="flex flex-col p-4">
              {orderDetailsList.map((order) => (
                ...
                >
                  <h3 className="font-bold break-words w-56 text-lg">Order ID: {order._id}</h3>
                  <div className="mt-2">
                    <h4 className="font-semibold text-xl uppercase">Your Items:</h4>
                    {order.items.map((item) => (
